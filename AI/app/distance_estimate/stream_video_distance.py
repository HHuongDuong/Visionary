...
def run_realtime_detection():
    ...
    while cap.isOpened():
        ...
        for i, box in enumerate(boxes):
            ...
            object_position_world = apply_extrinsic_transform(object_position_camera, rotation_matrix,
                                                              translation_vector)
...
calculate_focal_length(r"C:\Users\admin\Desktop\ONNX-YOLOv8-Object-Detection\dis.jpg")
