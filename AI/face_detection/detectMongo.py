...
def process_frame(frame, collection):
    ...
    try:
        ...
        if representations and isinstance(representations, list):
            ...
            response_data['error'] = "No faces detected."
        ...
        if analysis and isinstance(analysis, list):
            ...
            response_data['gender'] = dominant_gender
            response_data['emotion'] = dominant_emotion
            response_data['race'] = dominant_race
            ...
            if highest_similarity_face:
                ...
                response_data['recognized_as'] = name
                ...
                if boxes is not None and len(boxes) > 0:
                    ...
                    response_data['error'] = "No objects detected."

            analysis_result = json.dumps(response_data, ensure_ascii=False)
